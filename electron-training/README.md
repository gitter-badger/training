...
_募集: 現在[`atom/electron.atom.io`](https://github.com/atom/electron)で`atom/electron/docs`内の日本語翻訳をしようと、[Translation in Japanese #20](https://github.com/atom/electron.atom.io/issues/20)で話合われています。興味ある方はぜひ参加してください。_
